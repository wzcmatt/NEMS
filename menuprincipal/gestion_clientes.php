        ...
        <div class="row w-100 justify-content-center">
            <div class="col-md-6">
                <div class="module">
                    ...
                    <p class="mb-4">Crea, Elimina, Actualiza y Consulta clientes.</p>
                    <a href="http://localhost/PROYECTOSENANEMS/menuprincipal/clientes/consultar.php" class="btn btn-custom">
